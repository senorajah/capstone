...
const [FileReq2, setFileReq2] = React.useState('');
  ...
  return (
    <div
      className="border-2 justify-center items-center bg-cover bg-center absolute px-2 py-2 rounded-lg flex flex-col"
      ...
      <div className="h-40 w-72 border-grey border-2 rounded-lg bg-[#F7FAFF66]">
        <div className="flex-col px-2">
          <div className="flex justify-end " onClick={handleClick}>
            <BookmarkIcon  style={{ color: isClicked ? 'gold' : 'inherit' }} />
          </div>
